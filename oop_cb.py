...
if van:
    print(     f'            {sofor} {adas}x használta a CD rádiót')
else:
...
nev, darab = sorted(szotar.items(),key=lambda x:x[1], reverse=True)[0]
print(           f'9. feladat: A legtöbb adást indító sofőr:')
print(           f'            Név: {nev}')
print(           f'            Adások száma: {darab} alkalom')
